...
function peg$parse(input, options) {
  ...
  var peg$f30 = function peg$f30(chars) {
    return chars.join('');
  };

  var peg$f31 = function peg$f31(name) {
    return name;
  };

  var peg$f32 = function peg$f32(start, parts) {
  ...
  var peg$f37 = function peg$f37(ca) {
    return {
      type: 'string',
      value: ca[1].join('')
    };
  ...
  var peg$f47 = function peg$f47(h1, h2, h3, h4) {
    return String.fromCharCode(parseInt("0x" + h1 + h2 + h3 + h4));
  };

  var peg$f48 = function peg$f48(n) {
    return {
      type: 'number',
      value: n
    };
  ...
  var peg$f49 = function peg$f49(int_, frac, exp) {
    return parseFloat(int_ + frac + exp);
  };

  var peg$f50 = function peg$f50(int_, frac) {
    return parseFloat(int_ + frac);
  };

  var peg$f51 = function peg$f51(int_, exp) {
    return parseFloat(int_ + exp);
  };

  var peg$f52 = function peg$f52(int_) {
    return parseFloat(int_);
  };

  var peg$f53 = function peg$f53(digits) {
    return "." + digits;
  };

  var peg$f54 = function peg$f54(e, digits) {
    return e + digits;
  };

  var peg$f55 = function peg$f55(digits) {
    return digits.join("");
  };

  var peg$f56 = function peg$f56(e, sign) {
