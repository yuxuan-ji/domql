...
function peg$parse(input, options) {
  ...
  var peg$f5 = function peg$f5(dt, tail) {
    var obj = {
      table: dt
    };
  ...
  var peg$f23 = function peg$f23(tbl, col) {
    return {
      type: 'column_ref',
      column: col
    };
  ...
  var peg$f44 = function peg$f44(h1, h2, h3, h4) {
    return String.fromCharCode(parseInt("0x" + h1 + h2 + h3 + h4));
  };

  var peg$f45 = function peg$f45(n) {
    return {
      type: 'number',
      value: n
    };
  ...
  var peg$f46 = function peg$f46(int_, frac, exp) {
    return parseFloat(int_ + frac + exp);
  };

  var peg$f47 = function peg$f47(int_, frac) {
    return parseFloat(int_ + frac);
  };

  var peg$f48 = function peg$f48(int_, exp) {
    return parseFloat(int_ + exp);
  };

  var peg$f49 = function peg$f49(int_) {
    return parseFloat(int_);
  };

  var peg$f50 = function peg$f50(digits) {
    return "." + digits;
  };

  var peg$f51 = function peg$f51(e, digits) {
    return e + digits;
  };
  ...
  var peg$f53 = function peg$f53(e, sign) {
    return e + (sign !== null ? sign : '');
  };

  var peg$f54 = function peg$f54() {
    return 'ASC';
  };

  var peg$f55 = function peg$f55() {
    return 'DESC';
  };
