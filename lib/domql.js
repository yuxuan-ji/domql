...
function peg$parse(input, options) {
  ...
  var peg$e17 = peg$classExpectation(["'", "\\", ["\0", "\x1F"], "\x7F"], true, false);
  ...
  var peg$e34 = peg$literalExpectation("TRUE", true);
  var peg$e35 = peg$literalExpectation("FALSE", true);
  var peg$e36 = peg$literalExpectation("SELECT", true);
  var peg$e37 = peg$literalExpectation("FROM", true);
  var peg$e38 = peg$literalExpectation("WHERE", true);
  var peg$e39 = peg$literalExpectation("GROUP", true);
  var peg$e40 = peg$literalExpectation("BY", true);
  var peg$e41 = peg$literalExpectation("ORDER", true);
  var peg$e42 = peg$literalExpectation("LIMIT", true);
  var peg$e43 = peg$literalExpectation("ASC", true);
  var peg$e44 = peg$literalExpectation("DESC", true);
  var peg$e45 = peg$literalExpectation("IN", true);
  var peg$e46 = peg$literalExpectation("IS", true);
  var peg$e47 = peg$literalExpectation("LIKE", true);
  var peg$e48 = peg$literalExpectation("EXISTS", true);
  ...
  var peg$f6 = function peg$f6(t) {
    return t;
  };

  var peg$f7 = function peg$f7(dt, tail) {
    var obj = {
      type: 'table_ref',
      table: dt
    };
  ...
  var peg$f8 = function peg$f8(e) {
    return e;
  };

  var peg$f9 = function peg$f9(c, d) {
    var obj = c;
    obj.order = 'ASC';
  ...
  var peg$f10 = function peg$f10(i) {
    return i;
  };
  ...
  var peg$f12 = function peg$f12(head, tail) {
    return createBinaryExprChain(head, tail);
  };

  var peg$f13 = function peg$f13(expr) {
    return createUnaryExpr('NOT', expr);
  };

  var peg$f14 = function peg$f14(left, rh) {
  ...
  var peg$f15 = function peg$f15(op, stmt) {
    stmt.parentheses = true;
    return createUnaryExpr(op, stmt);
  };

  var peg$f16 = function peg$f16(nk) {
    return nk[0] + ' ' + nk[2];
  };

  var peg$f17 = function peg$f17(l) {
    return {
      type: 'arithmetic',
      tail: l
    };
  ...
  var peg$f19 = function peg$f19(right) {
    return {
      op: 'IS NOT',
      right: right
    };
  ...
  var peg$f20 = function peg$f20(op, right) {
    return {
      op: op,
      right: right
    };
  ...
  var peg$f21 = function peg$f21(op, l) {
    return {
      op: op,
      right: l
    };
  ...
  var peg$f23 = function peg$f23(e) {
    e.parentheses = true;
    return e;
  };

  var peg$f24 = function peg$f24(list) {
    list.parentheses = true;
    return list;
  };

  var peg$f25 = function peg$f25(tbl, col) {
    return {
      type: 'column_ref',
      table: tbl,
      column: col
  ...
  var peg$f26 = function peg$f26(col) {
    return {
      type: 'column_ref',
      column: col
    };
  ...
  var peg$f29 = function peg$f29(chars) {
    return chars.join('');
  };

  var peg$f30 = function peg$f30(name) {
    return name;
  };

  var peg$f31 = function peg$f31(start, parts) {
  ...
  var peg$f36 = function peg$f36(ca) {
    return {
      type: 'string',
      value: ca[1].join('')
    };
  ...
  var peg$f46 = function peg$f46(h1, h2, h3, h4) {
    return String.fromCharCode(parseInt("0x" + h1 + h2 + h3 + h4));
  };

  var peg$f47 = function peg$f47(n) {
    return {
      type: 'number',
      value: n
    };
  ...
  var peg$f48 = function peg$f48(int_, frac, exp) {
    return parseFloat(int_ + frac + exp);
  };

  var peg$f49 = function peg$f49(int_, frac) {
    return parseFloat(int_ + frac);
  };

  var peg$f50 = function peg$f50(int_, exp) {
    return parseFloat(int_ + exp);
  };

  var peg$f51 = function peg$f51(int_) {
    return parseFloat(int_);
  };

  var peg$f52 = function peg$f52(digits) {
    return "." + digits;
  };

  var peg$f53 = function peg$f53(e, digits) {
    return e + digits;
  };

  var peg$f54 = function peg$f54(digits) {
    return digits.join("");
  };

  var peg$f55 = function peg$f55(e, sign) {
    return e + (sign !== null ? sign : '');
  };

  var peg$f56 = function peg$f56() {
    return 'ASC';
  };

  var peg$f57 = function peg$f57() {
    return 'DESC';
  };

  var peg$f58 = function peg$f58() {
    return 'IN';
  };

  var peg$f59 = function peg$f59() {
    return 'IS';
  };

  var peg$f60 = function peg$f60() {
    return 'LIKE';
  };

  var peg$f61 = function peg$f61() {
    return 'EXISTS';
  };

  var peg$f62 = function peg$f62() {
    return 'NOT';
  };

  var peg$f63 = function peg$f63() {
    return 'AND';
  };

  var peg$f64 = function peg$f64() {
    return 'OR';
  };
...
function _getTableReferences(node) {
  ...
  node.forEach(function (table) {
    if (table.type !== "table_ref") throw new Error("Expected ".concat(table, " to be a table_ref"));
  ...
  function recurse(node) {
    ...
    if (node.type === "binary_expr") {
      if (node.operator === "AND" || node.operator === "OR") {
        ...
        if (!tables.has(node.left.table)) throw Error("Table ".concat(node.left.table, " was not specified in FROM statement"));
        var table = node.left.table;
        var column = node.left.column;
        var value = node.right.column || node.right.value;
        node["selector"] = {
          table: table,
          selector: "[".concat(column, "=\"").concat(value, "\"]")
        };
        node.type = "selector";
        delete node.left;
        delete node.right;
...
function transpile(ast) {
  ...
  if (ast.limit && ast.limit.value === 1) directives.push(document.querySelector.bind(document));else directives.push(document.querySelectorAll.bind(document));
  return directives;
}
